...
const StepperComponent = () => {
    ...
    return (
        <>
            ...
            <hr className='bg-primary' style={{ height: "1px", width: "80%", margin: "0 auto" }}/>
            ...
            <div className={cx({'d-none': step !== 2})}>
                <div className="btn-group py-3 d-flex w-50 text-center  mx-auto justify-content-center align-items-center" role="group" aria-label="Solid button group">
                    <PersonTypeButton 
